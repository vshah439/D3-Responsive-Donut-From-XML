...
//************************************************************
	...
	d3.xml("religiontree.xml", function(error, data) {
  		if (error) {throw error; alert("Enable to load XML file")};
	console.log(data);
...
//************************************************************
	...
	donut.append("path")
     		...
     		.attr("fill", function(d, i) { return "#"+d.data.color.substring(2,8); })
    		.transition()
    	 	.ease("exp")
     		.duration(1000)
...
//************************************************************
	donut.append("text")
    		 ...
    		 .attr("dy", ".35em")
     		.attr("dx", "-1em")
		.style("font-size", function (d){return radius*0.11+"px";})
     		.text(function(d) {if(d.data.data1>3) return d.data.data1+" %"; });
